...
- Missing body properties (addable): 427
- Missing query parameters (addable): 953
...
- Systemic gaps (distinct field names collapsed across high-confidence endpoints, detailed below): 246
- ValidateSet drift: 0
...
Showing the top 25 of 246 findings by endpoint count -- the full list is in the JSON manifest's `systemicGaps`, nothing is dropped there.
