...
Describe 'Get-PfbUserGroupQuotaPolicy' {
    ...
    It 'does not expose -TotalOnly (user-group-quota-policies does not declare total_only, #102)' {
        (Get-Command Get-PfbUserGroupQuotaPolicy).Parameters.Keys | Should -Not -Contain 'TotalOnly'
