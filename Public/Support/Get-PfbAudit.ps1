function Get-PfbAudit {
    <#
    .SYNOPSIS
        Retrieves FlashBlade audit log entries.
    .PARAMETER Name
        One or more audit entry names.
    .PARAMETER Id
        One or more audit entry IDs.
    .PARAMETER Filter
    ...
    .EXAMPLE
        Get-PfbAudit
    .EXAMPLE
        Get-PfbAudit -Filter "user='pureuser'" -Limit 50
    #>
